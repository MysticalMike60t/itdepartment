  ...
  return (
    <div className="instance learning">
      ...
      <div className="display display-credits">
        {items.map((data, key) => {
          return (
            <span className="item item-credit" key={key}><span>{data.credits}</span><p className="text">Credits</p><p className='year'><span className='year__y'>y</span>{data.year}</p></span>
          )
        })}
      </div>
